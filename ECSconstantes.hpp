...
const unsigned int COMPONENT_NOT_FOUND = 1000, SYSTEM_NOT_FOUND = 1001, NUMBR_COMPONENT = 12, NUMBR_SYSTEM = 5, NUMBR_INPUT = 6,
GROUND_UNDEFINED = 1002, NUM_MIN_COLL_COMPONENT = COLL_SEGMENT_COMPONENT, NUM_MAX_COLL_COMPONENT = COLL_RECTBOX_COMPONENT + 1;
